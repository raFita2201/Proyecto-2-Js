...
// 3.4 Usa el correcto operador de asignación que resultará en o = 15, teniendo p = 10 y j = 5.
let p = 10;
let j = 5;
let o = p + j;
console.log(o);

// 3.5 Usa el correcto operador de asignación que resultará en i = 50, teniendo c = 10 y m = 5.
let c = 10;
let m = 5;
let i = c * m;
console.log(i);